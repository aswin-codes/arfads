    ...
    <div className="px-5 pt-24 flex flex-wrap justify-around gap-5">
      <div className="max-w-2xl">
        <p className="text-4xl text-white font-medium pb-3">
          Turn Your Viewers Into Paying Customers & Charm Your Visitors
        </p>
        <p className="text-lg text-gray-500 pb-3">
        Effortlessly infuse your presence with visually stunning and dynamic elements that captivate your visitors. Our innovative digital solutions turn your cursor into a colorful magic wand, creating an engaging and memorable experience for your audience !
        </p>
